...
- Added contained-subproject GitHub Pages workflow generation.
- Documented runtime lessons for ServBay PHP, Node 20, npm/webpack pinning, nested `source/` gitignore exceptions, and partial translation state.
